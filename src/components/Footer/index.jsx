...
function Footer() {
  return (
    <div className="bg-footer w-full md:h-[450px] md:flex flex-col md:flex-row items-center gap-12 relative md:static">
      ...
      <div className="grow mt-4 md:mt-0">
        <div className="md:max-w-3xl pr-10 pl-10 md:pl-0 xl:pr-0">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-20 text-white text-2xl text-center mt-12 pb-40 md:pb-0">
            <div>
